...
const file_api_shortener_shortener_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/shortener/shortener.proto\x12!acyaskulskaya.shortener.shortener\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2*.acyaskulskaya.shortener.shortener.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xe2\x02\n" +
	"\x10ShortenerService\x12y\n" +
	"\n" +
	"ShortenURL\x124.acyaskulskaya.shortener.shortener.URLShortenRequest\x1a5.acyaskulskaya.shortener.shortener.URLShortenResponse\x12v\n" +
	"\tExpandURL\x123.acyaskulskaya.shortener.shortener.URLExpandRequest\x1a4.acyaskulskaya.shortener.shortener.URLExpandResponse\x12[\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a3.acyaskulskaya.shortener.shortener.UserURLsResponseB3Z1github.com/acya-skulskaya/shortener/api/shortenerb\beditionsp\xe8\a"
...
var file_api_shortener_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: acyaskulskaya.shortener.shortener.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: acyaskulskaya.shortener.shortener.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: acyaskulskaya.shortener.shortener.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: acyaskulskaya.shortener.shortener.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: acyaskulskaya.shortener.shortener.UserURLsResponse
	(*URLData)(nil),            // 5: acyaskulskaya.shortener.shortener.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_api_shortener_shortener_proto_depIdxs = []int32{
	5, // 0: acyaskulskaya.shortener.shortener.UserURLsResponse.url:type_name -> acyaskulskaya.shortener.shortener.URLData
	0, // 1: acyaskulskaya.shortener.shortener.ShortenerService.ShortenURL:input_type -> acyaskulskaya.shortener.shortener.URLShortenRequest
	2, // 2: acyaskulskaya.shortener.shortener.ShortenerService.ExpandURL:input_type -> acyaskulskaya.shortener.shortener.URLExpandRequest
	6, // 3: acyaskulskaya.shortener.shortener.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: acyaskulskaya.shortener.shortener.ShortenerService.ShortenURL:output_type -> acyaskulskaya.shortener.shortener.URLShortenResponse
	3, // 5: acyaskulskaya.shortener.shortener.ShortenerService.ExpandURL:output_type -> acyaskulskaya.shortener.shortener.URLExpandResponse
	4, // 6: acyaskulskaya.shortener.shortener.ShortenerService.ListUserURLs:output_type -> acyaskulskaya.shortener.shortener.UserURLsResponse
